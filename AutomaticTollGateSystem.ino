...
OnewireKeypad <Print, 16 > KP2(Serial, KEYS, 4, 3, A0, 4700, 1000);
...
void rfid()
{
  ...
  if (content.substring(1) == "27 53 AC CA")
  {
    if (card1Balance >= 500)
    {
      lcdPrint();
  ...
  else if (content.substring(1) == "33 94 D3 97")
  {
    if (card2Balance >= 500)
    {
      lcdPrint();
